...
\subsection{Model danych}
    ...
    \par Każda linia jest osobną instancją i kończy się znakiem '\textbackslash n'. Etykiety(ang. label) są używane na
    różne sposoby: \cite{CC01a}
    \begin{itemize}
    ...
    trenowania i testowania, a więc użycia dwóch plików z danymi. Pliki z danymi są zapisywane
    w takim samym formacie i różnią się tylko celem do którego będą użyte.
    ...
    \par Mechanizm sygnałów i gniazd biblioteki \textit{Qt} jest powszechnie używany w projekcie
    aplikacji. Sygnały najczęściej są wywoływane przez kontrolki na interfejsie graficznym, a
    gniazdem jest funkcja do której są przekazywane odpowiednie parametry.
