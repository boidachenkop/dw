...
\subsubsection{Przypadek liniowo nieseparowalnych danych}
    \par Najczęściej jest tak, że dane nie są liniowo separowalne, a więc musi być metoda na
    radzenie sobie w takich przypadkach.

    % TODO work here. Non separatable
